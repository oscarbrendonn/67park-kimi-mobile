...
export async function loadSmallIslandProps({scene,renderer,sample,variant}){
 ...
 const [houseGltf,foliageGltf,layout]=await Promise.all([
  new GLTFLoader().loadAsync('/67park-kimi-mobile/island/small-island-houses-v61.glb?v=houses1'),
  new GLTFLoader().loadAsync('/67park-kimi-mobile/island/small-island-props-v45.glb?v=round1'),
