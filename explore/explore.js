...
// explore-local-helper:/67park-kimi-mobile/app/island-startup-warmup.js
...
try {
  ...
  resize();
  const { createIslandRuntime } = await import("/67park-kimi-mobile/island/runtime.bundle.js?v=vehicle-48");
